...
/** @var \common\models\Order $earings */
/** @var \common\models\OrderItem $products */
/** @var \common\models\Order $orderMade */
/** @var \common\models\Order $totalUser */
/** @var array $data */
/** @var array $labels */
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo Yii::$app->formatter->asCurrency($earings); ?>
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        <?php  foreach ($countries as $i => $country):  ?>
                            <span class="mr-2">
                                <i class="fas fa-circle text-primary" style="color:<?php echo $bgColors[$i];?>"></i> <?php echo $country  ?>
                            </span>
                        <?php  endforeach;  ?>
                    </div>
                </div>
